...
namespace MedicalSystem.API.Migrations
{
    ...
    [Migration("20241126204518_AddTablesMedicalRecordAndPersciption")]
    partial class AddTablesMedicalRecordAndPersciption
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalSystem.API.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 26, 20, 45, 18, 3, DateTimeKind.Utc).AddTicks(6749),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFQ2yKBsGn29+ggVLt6ARw6MpnoGMdbsDnfIGkqAoxGAV8rnacZwcUD4WUDzLuFxgw==",
